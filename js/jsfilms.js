document.addEventListener("DOMContentLoaded", function() {
    ...
    // При загрузке страницы отображаем сохраненные отзывы
    displaySavedFeedbacks();
    ...
    feedbackForm.addEventListener("submit", function(event) {
        ...
        const comment = feedbackForm.elements["comment"].value;
    ...
    // Функция сохранения отзыва в локальном хранилище
    ...
    // Функция отображения сохраненных отзывов
    function displaySavedFeedbacks() {
        let savedFeedbacks = JSON.parse(localStorage.getItem("feedbacks")) || [];
    ...
    function displayFeedback(feedback) {
        ...
        feedbackElement.innerHTML = `<strong>${feedback.name}</strong>: ${feedback.comment}`;
